...
class_objTab:
	...
	.word	PrintCommand_protObj
	.word	PrintCommand_init
...
EvalCommand_dispTab:
	...
	.word	EvalCommand.find_next_int
	.word	EvalCommand.find_int
	.word	EvalCommand.pop_int
PrintCommand_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	PrintCommand.eval
	.word	PrintCommand.print_stack
PushCommand_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
...
EvalCommand_protObj:
	...
	.word	-1
PrintCommand_protObj:
	.word	10
	.word	3
	.word	PrintCommand_dispTab
	.word	-1
PushCommand_protObj:
	.word	9
	.word	3
...
label243:
	...
	sw	$a0 0($sp)
	addiu	$sp $sp -4
	la	$a0 PrintCommand_protObj
	jal	Object.copy
	jal	PrintCommand_init
