...
int main(int argc, char** argv) {
    ...
    std::string outdir = "results/sol";     //@@ Thien Lu added
    ...
    //@@ Thien Lu added
    // compute speedup
    float speedUp = minSerial / minThread;
    printf("\t\t\t\t(%.2fx speedup from %d threads)\n", speedUp, numThreads);

    // write result 
    std::string speedout = outdir + "/speed_results";
    writeSpeedResults(speedout, numThreads, speedUp);
    //@@
